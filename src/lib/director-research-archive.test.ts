...
const job: DirectorResearchJob = { id: "j1", sourceId: "s1", sourceTitle: "Archive", sourceMode: "collection-discovery", queryKey: "q", queryLabel: "Query", status: "review-required", phase: "review", progress: 100, message: "Done", attempt: 1, maxAttempts: 3, model: null, errorMessage: null, evidenceCount: 1, output: { manifestIds: ["e1"] }, usage: {}, createdAt: "2026-08-01T00:00:00Z", updatedAt: "2026-08-01T01:00:00Z", startedAt: null, completedAt: null, events: [{ id: "1", kind: "job-status", phase: "review", status: "review-required", progress: 100, message: "Done", details: {}, actor: null, createdAt: "2026-08-01T01:00:00Z" }] };
const evidence: DirectorEvidenceManifest = { id: "e1", sourceId: "s1", researchJobId: "j1", kind: "collection-item", provider: "museum", externalId: "x", canonicalUrl: "https://example.com/x", recordLocator: "x", title: "Object", institution: "Museum", dateLabel: "1960", region: "US", tags: [], facets: {}, rightsUri: null, rightsLabel: "Public domain", reuseStatus: "reusable", culturallySensitive: false, status: "eligible", reviewNotes: "Reviewed from the canonical record.", linkedStudyIds: ["st1"], updatedAt: "2026-08-01T02:00:00Z" };
