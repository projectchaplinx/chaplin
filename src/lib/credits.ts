...
export const CREDIT_CATALOG: readonly CreditCatalogItem[] = [
  ...
  { code: "production.punch.15", label: "Punch", credits: PUNCH_15S_CREDITS, unit: "15-second production", billing: "direct", category: "production", description: "Four authored scene clips assembled into one finished 15-second master." },
