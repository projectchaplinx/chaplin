      ...
      if (!available.length) {
        setMessage(
          isAdmin
            ...
            : "No inactive Chaplin voice is available to delete for this actor. Active voices and voices outside your actor stay protected.",
        );
      }
    } catch (error) {
  ...
  return (
    <div className="w-full rounded-md border border-red-500/25 bg-black/20 p-3" data-voice-capacity-recovery>
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          <p className="text-[10px] font-semibold text-ink">Inactive Chaplin voices</p>
          <p className="mt-1 text-[9px] leading-4 text-grey">
            {adminMode
              ...
              : "Locked voices cannot be deleted. You only see inactive Chaplin voices belonging to this actor."}
          </p>
        </div>
